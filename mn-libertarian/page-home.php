<?php get_header(); ?>
<link rel="stylesheet" href="/wordpress/wp-content/themes/mn-libertarian/vendor/slick/slick.css" type="text/css" media="screen" />
<link rel="stylesheet" href="/wordpress/wp-content/themes/mn-libertarian/vendor/slick/slick-theme.css" type="text/css" media="screen" />
		...
		<div class="slick-slider">
		  	<?php
				if (get_field('slide_one')) {
					echo '<div><a id="slide_1" href="' . get_field('slide_one_click_url') . '"><img src="' . get_field('slide_one') . '" /></a></div>';
				}
				if (get_field('slide_two')) {
					echo '<div><a id="slide_2" href="' . get_field('slide_two_click_url') . '"><img data-lazy="' . get_field('slide_two') . '" /></a></div>';
				}
				if (get_field('slide_three')) {
					echo '<div><a id="slide_3" href="' . get_field('slide_three_click_url') . '"><img data-lazy="' . get_field('slide_three') . '" /></a></div>';
				}
				if (get_field('slide_four')) {
					echo '<div><a id="slide_4" href="' . get_field('slide_four_click_url') . '"><img data-lazy="' . get_field('slide_four') . '" /></a></div>';
				}
			?>
		</div>
	</div>
...
<?php get_footer(); ?>
    ...
    <script src="/wordpress/wp-content/themes/mn-libertarian/vendor/slick/slick.min.js"></script>
